...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Drive', fields ['user_profile']
        db.delete_unique('heech_server_app_drive', ['user_profile_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Drive', fields ['user_profile']
        db.create_unique('heech_server_app_drive', ['user_profile_id'])
    ...
    models = {
        ...
        'heech_server_app.drive': {
            ...
            'drive_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 4, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            ...
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['heech_server_app.UserProfile']"})
        },
